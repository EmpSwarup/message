...
export async function POST(request: Request){
  ...
  try {
    ...
    return Response.json(
      {
        success: true,
        message: "Message acceptance statys updated succesfully",
        updatedUser
      },
      {
        status: 200
...
export async function GET(request: Request){
  ...
  try {
    ...
    return Response.json(
      {
        success: true,
        isAccetingMessages: foundUser.isAcceptingMessage
      },
      {
        status: 200
      }
    ...
    return Response.json(
      {
        success: false,
        message: "Error is getting status of message acceptance"
      },
      {
        status: 500
      }
